$(document).ready(function () {
  ...
  var modalText = {
    discover: {
      ...
      link: 'https://itruhul.blogspot.com/'
    },
    ordering: {
    ...
    walker: {
      ...
      detail: 'Walker Tracker offers goal management, fitness tracking, and team competitions to companies for internal use. A Laravel on PHP and Javascript companion site for the Walker Tracker App. Features visual metrics and gamified progression system.',
      link: 'https://itruhul.blogspot.com/'
    },
    powur: {
      title: 'Powur.com',
      tag: 'CONSUMER POWERED MARKETING.',
      detail: 'Powur is a marketing platform for lead generation, recruitment, and team building. Built with Laravel on PHP and Angular-UI. Makes use of Angular-material for front-end visuals. Features complex user tree heiarchy and commission system.',
      link: 'https://itruhul.blogspot.com/'
    },
    mystand: {
      title: 'MyStand',
